...
class _R_Image_AssetResource {
  ...
  /// asset: lib/assets/images/bubbles.jpg
  ...
  // ignore: non_constant_identifier_names
  final logo =
      const AssetResource("assets/images/logo.png", packageName: R.package);

  /// asset: lib/assets/images/whater.jpg
  // ignore: non_constant_identifier_names
  final whater_jpg =
      const AssetResource("assets/images/whater.jpg", packageName: R.package);
}
...
class _R_Image {
  ...
  /// asset: lib/assets/images/whater.jpg
  // ignore: non_constant_identifier_names
  AssetImage whater_jpg() {
    return AssetImage(asset.whater_jpg.keyName);
  }
}
